...
import "./SingleProductDetailsmedicine.css";
...
function SingleProductDetailsmedicine() {
    const { id } = useParams();
    const medicineProductItems = useSelector((state) => state.allCart.medicineProductItems);
    const item = medicineProductItems.find((p) => p.id === parseInt(id, 10));
    ...
    <>
        ...
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const PilexCapsulesUsageKey = `Benefits${index + 1}`;
                const PilexCapsulesUsageValue = item[PilexCapsulesUsageKey];
...
{item.Usage && (
    <>
        ...
        <ul className='ul_benifits'>
            {[...Array(28).keys()].map((index) => {
                const PilexCapsulesUsageKey = `Usage${index + 1}`;
                const PilexCapsulesUsageValue = item[PilexCapsulesUsageKey];
    ...
    <>
        ...
        <ul className='ul_benifits'>
            {[...Array(28).keys()].map((index) => {
                const PilexCapsulesUsageKey = `UsageofPiloxMB${index + 1}`;
                const PilexCapsulesUsageValue = item[PilexCapsulesUsageKey];
...
{item.Ingredients && (
    <>
        ...
        <ul className='ul_benifits'>
            {[...Array(28).keys()].map((index) => {
                const PilexCapsulesUsageKey = `Ingredients${index + 1}`;
                const PilexCapsulesUsageValue = item[PilexCapsulesUsageKey];
...
{item.Special && (
    ...
    <>
        ...
        <ul className='ul_benifits'>
            {[...Array(28).keys()].map((index) => {
                const PilexCapsulesUsageKey = `SpecialInstructions${index + 1}`;
                const PilexCapsulesUsageValue = item[PilexCapsulesUsageKey];
...
export default SingleProductDetailsmedicine
