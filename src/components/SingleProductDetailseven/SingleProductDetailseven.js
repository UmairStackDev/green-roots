...
import "./SingleProductDetailseven.css";
...
function SingleProductDetailseven() {
    const { id } = useParams();
    const topRatedItems = useSelector((state) => state.allCart.topRatedItems);
    const item = topRatedItems.find((p) => p.id === parseInt(id, 10));
...
Add to Cart
                    ...
                    <div className="main_product main_product_1">
                        ...
                        <ul className='ul_benifits'>
                            <li>{item.BenefitsofPigmentationNightCream1}</li>
                        </ul>

                        <h2 className='benifits'>{item.BenefitsofPigmentationSunBlock}</h2>
                        <ul className='ul_benifits'>
                            <li>{item.BenefitsofPigmentationSunBlock1}</li>
                            <li>{item.BenefitsofPigmentationSunBlock2}</li>
                            <li>{item.BenefitsofPigmentationSunBlock3}</li>
                            <li>{item.BenefitsofPigmentationSunBlock4}</li>

                        </ul>

                        <h2 className='benifits'>{item.BenefitsofPigmentationSerum}</h2>
                        <ul className='ul_benifits'>
                            <li>{item.BenefitsofPigmentationSerum1}</li>
                            <li>{item.BenefitsofPigmentationSerum2}</li>
                            <li>{item.BenefitsofPigmentationSerum3}</li>
                            <li>{item.BenefitsofPigmentationSerum4}</li>
                            <li>{item.BenefitsofPigmentationSerum5}</li>

                        </ul>

                        <h2 className='benifits'>{item.BenefitsofPigmentationOrangeFacewash}</h2>
                        <ul className='ul_benifits'>
                            <li>{item.BenefitsofPigmentationOrangeFacewash1}</li>
                            <li>{item.BenefitsofPigmentationOrangeFacewash2}</li>
                            <li>{item.BenefitsofPigmentationOrangeFacewash3}</li>
                            <li>{item.BenefitsofPigmentationOrangeFacewash4}</li>
                            <li>{item.BenefitsofPigmentationOrangeFacewash5}</li>
                        ...
                        <div className="use my-3">
                            ...
                            <ul className='ul_benifits'>
                                <li>{item.UsageofAcneClear1}</li>
                                <li>{item.UsageofAcneClear2}</li>
                        ...
                        <div className="use my-3">
                            ...
                            <ul className='ul_benifits'>
                                <li>{item.UsageofAcneDiffuser1}</li>
                                <li>{item.UsageofAcneDiffuser2}</li>
                        ...
                        <div className="use my-3">
                            ...
                            <ul className='ul_benifits'>
                                <li>{item.UsageofAntiAcne1}</li>
                                <li>{item.UsageofAntiAcne2}</li>
                        ...
                        <div className="use my-3">
                            ...
                            <ul className='ul_benifits'>
                                <li>{item.NightCreamIngredient1}</li>
                                <li>{item.NightCreamIngredient2}</li>
                                <li>{item.NightCreamIngredient3}</li>
                                <li>{item.NightCreamIngredient4}</li>
                                <li>{item.NightCreamIngredient5}</li>
                                <li>{item.NightCreamIngredient6}</li>
                                <li>{item.NightCreamIngredient7}</li>
                                <li>{item.NightCreamIngredient8}</li>
                                <li>{item.NightCreamIngredient9}</li>
                                <li>{item.NightCreamIngredient10}</li>
                                <li>{item.NightCreamIngredient11}</li>
                        ...
                        <div className="use my-3">
                            ...
                            <ul className='ul_benifits'>
                                <li>{item.SunBlockIngredients1}</li>
                                <li>{item.SunBlockIngredients2}</li>
                                <li>{item.SunBlockIngredients3}</li>
                                <li>{item.SunBlockIngredients4}</li>
                                <li>{item.SunBlockIngredients5}</li>
                                <li>{item.SunBlockIngredients6}</li>
                                <li>{item.SunBlockIngredients7}</li>
                                <li>{item.SunBlockIngredients8}</li>
                                <li>{item.SunBlockIngredients9}</li>
                                <li>{item.SunBlockIngredients10}</li>
                        ...
                        <div className="use my-3">
                            ...
                            <ul className='ul_benifits'>
                                <li>{item.SerumIngredients1}</li>
                                <li>{item.SerumIngredients2}</li>
                                <li>{item.SerumIngredients3}</li>
                                <li>{item.SerumIngredients4}</li>
                                <li>{item.SerumIngredients5}</li>
                                <li>{item.SerumIngredients6}</li>
                                <li>{item.SerumIngredients7}</li>
                                <li>{item.SerumIngredients8}</li>
                                <li>{item.SerumIngredients9}</li>
                        ...
                        <div className="use my-3">
                            ...
                            <ul className='ul_benifits'>
                                <li>{item.FaceWashIngredients1}</li>
                                <li>{item.FaceWashIngredients2}</li>
                                <li>{item.FaceWashIngredients3}</li>
                                <li>{item.FaceWashIngredients4}</li>
                                <li>{item.FaceWashIngredients5}</li>
                                <li>{item.FaceWashIngredients6}</li>
                                <li>{item.FaceWashIngredients7}</li>
                                <li>{item.FaceWashIngredients8}</li>
                        ...
                        <div className="use my-3">
                            ...
                            <ul className='ul_benifits'>
                                ...
                                <li>{item.SpecialInstructions6}</li>
...
export default SingleProductDetailseven
