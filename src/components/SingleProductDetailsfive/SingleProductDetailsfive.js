...
import "./SingleProductDetailsfive.css";
...
function SingleProductDetailsfive() {
    const { id } = useParams();
    const essentailOilsMainItems = useSelector((state) => state.allCart.essentailOilsMainItems);
    const item = essentailOilsMainItems.find((p) => p.id === parseInt(id, 10));
...
Add to Cart
                    ...
                    <div className="main_product main_product_1">
                        ...
                        <div className="use my-3">
                            <h2 className='Usage'>{item.UsesofBlackPepperoil}</h2>
                            <ul className='ul_benifits'>
                                <li>{item.UsesofBlackPepperoil1}</li>
                                <li>{item.UsesofBlackPepperoil2}</li>
                                <li>{item.UsesofBlackPepperoil3}</li>
                                <li>{item.UsesofBlackPepperoil4}</li>
                                <li>{item.UsesofBlackPepperoil5}</li>
                                <li>{item.UsesofBlackPepperoil6}</li>
...
export default SingleProductDetailsfive
