...
import "./SingleProductDetailsEssential.css";
...
function SingleProductDetailsEssential() {
    const { id } = useParams();
    const essentialOilsItems = useSelector((state) => state.allCart.essentialOilsItems);
    const item = essentialOilsItems.find((p) => p.id === parseInt(id, 10));
...
export default SingleProductDetailsEssential
