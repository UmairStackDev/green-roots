...
import "./Medicine.css"
import health from "../../assets/medicines-category-greenrootspk.com_.jpg"
// importing aos
import AOS from 'aos';
...
function Medicine() {
    ...
    const dispatch = useDispatch();
      ...
      const filteredItems = medicineProductItems.filter((item) =>
                  ...
                  <div className="product-item clearfix" data-productid="4125">
                    ...
                    <div className="caption">
                      <div className="details">
                        ...
                        <div className="prices"><span>{item.ml}</span> <span>{item.gram}<span>{item.tablet}</span><span>{item.Capsules}</span></span><br /><span
