...
import "./SingleProductDetailssix.css";
...
function SingleProductDetailssix() {
    const { id } = useParams();
    const naturalOilMainItems = useSelector((state) => state.allCart.naturalOilMainItems);
    const item = naturalOilMainItems.find((p) => p.id === parseInt(id, 10));
...
export default SingleProductDetailssix
