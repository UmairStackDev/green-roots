...
import "./SingleProductDetailshealth.css";
...
function SingleProductDetailshealth() {
  const { id } = useParams();
  const healthProductItems = useSelector((state) => state.allCart.healthProductItems);
  const item = healthProductItems.find((p) => p.id === parseInt(id, 10));
 ...
 {item.BenefitsofPigmentationSerum && (
        ...
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                ...
                return null;
                   ...
                   {item.Howtouse && (
    <>
        <h2 className='benifits'>{item.Howtouse}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `Howtouse${index + 1}`;
                const benefitValue = item[benefitKey];
        ...
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                ...
                return null;
                   ...
                   {item.UsageofPiloxMB && (
    <>
        <h2 className='benifits'>{item.UsageofPiloxMB}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `UsageofPiloxMB${index + 1}`;
                const benefitValue = item[benefitKey];
    ...
    <>
        <h2 className='benifits'>{item.UsageofAcneClear}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `UsageofAcneClear${index + 1}`;
                const benefitValue = item[benefitKey];
...
{item.UsageofAcneDiffuser && (
    <>
        <h2 className='benifits'>{item.UsageofAcneDiffuser}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `UsageofAcneDiffuser${index + 1}`;
                const benefitValue = item[benefitKey];
    ...
    <>
        <h2 className='benifits'>{item.UsageofAntiAcne}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `UsageofAntiAcne${index + 1}`;
                const benefitValue = item[benefitKey];
    ...
    <>
        <h2 className='benifits'>{item.NightCreamIngredient}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `NightCreamIngredient${index + 1}`;
                const benefitValue = item[benefitKey];
    ...
    <>
        <h2 className='benifits'>{item.SunBlockIngredients}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `SunBlockIngredients${index + 1}`;
                const benefitValue = item[benefitKey];
    ...
    <>
        <h2 className='benifits'>{item.SerumIngredients}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `SerumIngredients${index + 1}`;
                const benefitValue = item[benefitKey];
    ...
    <>
        <h2 className='benifits'>{item.FaceWashIngredients}</h2>
        <ul className='ul_benifits'>
            {[...Array(35).keys()].map((index) => {
                const benefitKey = `FaceWashIngredients${index + 1}`;
                const benefitValue = item[benefitKey];
                ...
                return null;
                        ...
                        <div className="table_" style={{ paddingBottom: '50px' }}>
                            <table>
                                ...
                                <th>{item.NightCream}</th>
                                <td>{item.NightCream1}</td>
                                ...
                                <tr>
                                <th>{item.Facewash}</th>
                                <td>{item.Facewash1}</td>
                                </tr>
                                <tr>
                                <th>{item.HerbalTeaQuantity}</th>
                                <td>{item.HerbalTeaQuantity1}</td>
                                </tr>
                            </table>
                        </div>
...
export default SingleProductDetailshealth
