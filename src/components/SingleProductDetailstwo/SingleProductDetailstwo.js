...
import "./SingleProductDetailstwo.css";
...
function SingleProductDetailstow() {
    const { id } = useParams();
    const healthProductMainItems = useSelector((state) => state.allCart.healthProductMainItems);
    const item = healthProductMainItems.find((p) => p.id === parseInt(id, 10));
                    ...
                    <div className="main_product main_product_1">
                        ...
                        <div className="table_" style={{ paddingBottom: '50px' }}>
                            <table>
                                ...
                                <tr>
                                    <th>{item.FacewashQuantity}</th>
                                    <td>{item.FacewashQuantity1}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                <th>{item.NightCreamQuantity}</th>
                                    <td>{item.NightCreamQuantity1}</td>
                                </tr>
                                <tr>
...
export default SingleProductDetailstow
