...
import "./SingleProductDetailsNatural.css";
...
function SingleProductDetailsNatural() {
    const { id } = useParams();
    const naturalOilItems = useSelector((state) => state.allCart.naturalOilItems);
    const item = naturalOilItems.find((p) => p.id === parseInt(id, 10));
...
export default SingleProductDetailsNatural
